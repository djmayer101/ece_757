...
;
            FpSrcReg1 = xc->readFloatRegOperandBits(this, 0);
FpDestReg = xc->readFloatRegOperandBits(this, 1);
ccFlagBits = xc->readIntRegOperand(this, 2);
cfofBits = xc->readIntRegOperand(this, 3);
dfBit = xc->readIntRegOperand(this, 4);
ecfBit = xc->readIntRegOperand(this, 5);
ezfBit = xc->readIntRegOperand(this, 6);
...
PredccFlagBits = ((((ext & (PFBit | AFBit | ZFBit | SFBit
                ...
                ((ext & (PFBit | AFBit | ZFBit | SFBit )) != 0))) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
PredcfofBits = ((((ext & CFBit) == 0 ||
                (ext & OFBit) == 0) && ((ext & (CFBit | OFBit)) != 0))) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
PreddfBit = ((false)) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
PredecfBit = ((false)) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
PredezfBit = ((false)) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
;
...
;
            SrcReg1 = xc->readIntRegOperand(this, 0);
SrcReg2 = xc->readIntRegOperand(this, 1);
cfofBits = xc->readIntRegOperand(this, 2);
;
...
PredccFlagBits = ((((ext & (PFBit | AFBit | ZFBit | SFBit
                ...
                ((ext & (PFBit | AFBit | ZFBit | SFBit )) != 0))) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
cfofBits = xc->readIntRegOperand(this, _sourceIndex++);
PredcfofBits = ((((ext & CFBit) == 0 ||
                (ext & OFBit) == 0) && ((ext & (CFBit | OFBit)) != 0))) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
PreddfBit = ((false)) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
PredecfBit = ((false)) ? xc->readIntRegOperand(this, _sourceIndex++) : 0;
...
;
            SrcReg1 = xc->readIntRegOperand(this, 0);
cfofBits = xc->readIntRegOperand(this, 1);
;
...
SrcReg2 = xc->readIntRegOperand(this, 1);
DestReg = xc->readIntRegOperand(this, 2);
ccFlagBits = xc->readIntRegOperand(this, 3);
cfofBits = xc->readIntRegOperand(this, 4);
dfBit = xc->readIntRegOperand(this, 5);
ecfBit = xc->readIntRegOperand(this, 6);
ezfBit = xc->readIntRegOperand(this, 7);
;
...
SrcReg1 = xc->readIntRegOperand(this, 0);
NRIP = __parserAutoPCState.npc();
ccFlagBits = xc->readIntRegOperand(this, 1);
cfofBits = xc->readIntRegOperand(this, 2);
dfBit = xc->readIntRegOperand(this, 3);
ecfBit = xc->readIntRegOperand(this, 4);
ezfBit = xc->readIntRegOperand(this, 5);
...
uint64_t ezfBit = 0;
;
            ccFlagBits = xc->readIntRegOperand(this, 0);
cfofBits = xc->readIntRegOperand(this, 1);
dfBit = xc->readIntRegOperand(this, 2);
ecfBit = xc->readIntRegOperand(this, 3);
ezfBit = xc->readIntRegOperand(this, 4);
;
