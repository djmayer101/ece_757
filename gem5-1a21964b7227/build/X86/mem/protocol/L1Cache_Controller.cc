 ...
 *
 * Auto generated C++ code started by /filespace/people/c/collinsm/ece757/project/ece_757/gem5-1a21964b7227/src/mem/slicc/symbols/StateMachine.py:416
...
L1Cache_Controller::b_issuePUT(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:274: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:287: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:301: %s.\n", "assert failure");
...
L1Cache_Controller::r_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:345: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:346: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
L1Cache_Controller::s_store_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:363: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:364: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:372: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:373: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
L1Cache_Controller::forward_eviction_to_cpu(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    DPRINTF(RubyGenerated, "executing forward_eviction_to_cpu\n");
        if (m_send_evictions) {
        DPRINTF(RubySlicc, "MI_example-cache.sm:389: Sending invalidation for %s to the CPU\n", addr);
...
L1Cache_Controller::x_copyDataFromCacheToTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:405: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:406: %s.\n", "assert failure");
            ...
            if ((param_type == RubyRequestType_IFETCH)) {
                return L1Cache_Event_Ifetch;
                    ...
                    if (((param_type == RubyRequestType_ST) || (param_type == RubyRequestType_ATOMIC))) {
                        ...
                        panic("Runtime Error at MI_example-cache.sm:122: %s.\n", ("Invalid RubyRequestType"));
                        ;
                    }
                }
            }
