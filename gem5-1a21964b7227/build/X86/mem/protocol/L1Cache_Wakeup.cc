// Auto generated C++ code started by /filespace/people/c/collinsm/ece757/project/ece_757/gem5-1a21964b7227/src/mem/slicc/symbols/StateMachine.py:1036
                                                ...
                                                if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_WB_NACK)) {
                                                    ...
                                                    ;
                                                        ...
                                                        if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_INV)) {
                                                            ...
                                                            panic("Runtime Error at MI_example-cache.sm:216: %s.\n", ("Unexpected message"));
                                                            ;
                                                        }
                                                    }
                                                }
                            ...
                            L1Cache_TBE* tbe
                             = (((*m_L1Cache_TBEs_ptr)).lookup(((*in_msg_ptr)).m_Address));
                                if ((((*in_msg_ptr)).m_Type == CoherenceResponseType_DATA)) {
                                    ...
                                    panic("Runtime Error at MI_example-cache.sm:233: %s.\n", ("Unexpected message"));
                                    ;
                                }
                                }
                            }
