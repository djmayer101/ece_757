 ...
 *
 *
 * Auto generated C++ code started by /filespace/people/c/collinsm/ece757/project/ece_757/gem5-1a21964b7227/src/mem/slicc/symbols/Type.py:230
 */
...
(Tick curTime) : Message(curTime) {
    ...
    MemoryMsg(const Tick curTime, const Address& local_Address, const MemoryRequestType& local_Type, const MachineID& local_Sender, const MachineID& local_OriginalRequestorMachId, const DataBlock& local_DataBlk, const MessageSizeType& local_MessageSize, const PrefetchBit& local_Prefetch, const bool& local_ReadX, const int& local_Acks)
        : Message(curTime)
    {
