...
(Tick curTime) : NetworkMessage(curTime) {
    ...
    RequestMsg(const Tick curTime, const Address& local_Address, const CoherenceRequestType& local_Type, const MachineID& local_Requestor, const NetDest& local_Destination, const DataBlock& local_DataBlk, const MessageSizeType& local_MessageSize)
