...
(Tick curTime) : NetworkMessage(curTime) {
    ...
    ResponseMsg(const Tick curTime, const Address& local_Address, const CoherenceResponseType& local_Type, const MachineID& local_Sender, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const MessageSizeType& local_MessageSize)
