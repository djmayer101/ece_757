...
class BranchPredictorParams(param_SimObject.SimObjectParams):
    ...
    localHistoryBits = _swig_property(_param_BranchPredictor.BranchPredictorParams_localHistoryBits_get, _param_BranchPredictor.BranchPredictorParams_localHistoryBits_set)
    ...
    globalHistoryBits = _swig_property(_param_BranchPredictor.BranchPredictorParams_globalHistoryBits_get, _param_BranchPredictor.BranchPredictorParams_globalHistoryBits_set)
