...
class X86ISA_COLONS_I82094AA(param_BasicPioDevice.BasicPioDevice):
...
class I82094AAParams(param_BasicPioDevice.BasicPioDeviceParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_I82094AA.I82094AAParams_create(self)
