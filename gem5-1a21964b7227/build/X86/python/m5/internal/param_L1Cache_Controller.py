...
import param_RubyCache
import param_SimObject
import drain
import serialize
import param_RubySequencer
import param_RubyPort
import param_System
...
class L1Cache_Controller(param_RubyController.AbstractController):
...
class L1Cache_ControllerParams(param_RubyController.RubyControllerParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
