...
class LinuxX86System(param_X86System.X86System):
...
class LinuxX86SystemParams(param_X86System.X86SystemParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
