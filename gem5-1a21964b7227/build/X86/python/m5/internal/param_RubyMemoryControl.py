...
import param_MemoryControl
import param_RubySystem
import param_ClockedObject
import param_SimObject
import drain
import serialize
class RubyMemoryControl(param_MemoryControl.MemoryControl):
...
class RubyMemoryControlParams(param_MemoryControl.MemoryControlParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
