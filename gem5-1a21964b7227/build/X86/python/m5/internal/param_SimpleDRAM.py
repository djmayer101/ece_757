...
import enum_MemSched
import enum_PageManage
import enum_AddrMap
...
import drain
import serialize
class SimpleDRAM(param_AbstractMemory.AbstractMemory):
...
class SimpleDRAMParams(param_AbstractMemory.AbstractMemoryParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    write_thresh_perc = _swig_property(_param_SimpleDRAM.SimpleDRAMParams_write_thresh_perc_get, _param_SimpleDRAM.SimpleDRAMParams_write_thresh_perc_set)
    ...
    lines_per_rowbuffer = _swig_property(_param_SimpleDRAM.SimpleDRAMParams_lines_per_rowbuffer_get, _param_SimpleDRAM.SimpleDRAMParams_lines_per_rowbuffer_set)
