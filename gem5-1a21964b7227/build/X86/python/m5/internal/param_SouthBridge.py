...
import param_I8259
import enum_X86I8259CascadeMode
import param_Platform
import param_IntrControl
import param_I8237
import param_PcSpeaker
import param_I8254
import param_I82094AA
import param_Cmos
class SouthBridge(param_SimObject.SimObject):
...
class SouthBridgeParams(param_SimObject.SimObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_SouthBridge.SouthBridgeParams_create(self)
