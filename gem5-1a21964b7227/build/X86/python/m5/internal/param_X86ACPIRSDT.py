...
import drain
import serialize
class X86ISA_COLONS_ACPI_COLONS_RSDT(param_X86ACPISysDescTable.X86ISA_COLONS_ACPI_COLONS_SysDescTable):
...
class X86ACPIRSDTParams(param_X86ACPISysDescTable.X86ACPISysDescTableParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
