...
import drain
import serialize
class X86ISA_COLONS_IntSourcePin(param_SimObject.SimObject):
...
class X86IntSourcePinParams(param_SimObject.SimObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_X86IntSourcePin.X86IntSourcePinParams_create(self)
    def __init__(self): 
