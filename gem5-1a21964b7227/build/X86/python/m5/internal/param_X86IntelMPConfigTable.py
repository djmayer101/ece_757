...
class X86ISA_COLONS_IntelMP_COLONS_ConfigTable(param_SimObject.SimObject):
...
class X86IntelMPConfigTableParams(param_SimObject.SimObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_X86IntelMPConfigTable.X86IntelMPConfigTableParams_create(self)
