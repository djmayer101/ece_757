...
import drain
import serialize
class X86ISA_COLONS_IntelMP_COLONS_LocalIntAssignment(param_X86IntelMPBaseConfigEntry.X86ISA_COLONS_IntelMP_COLONS_BaseConfigEntry):
...
class X86IntelMPLocalIntAssignmentParams(param_X86IntelMPBaseConfigEntry.X86IntelMPBaseConfigEntryParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_X86IntelMPLocalIntAssignment.X86IntelMPLocalIntAssignmentParams_create(self)
