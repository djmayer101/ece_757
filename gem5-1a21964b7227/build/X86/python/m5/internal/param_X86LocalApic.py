...
class X86ISA_COLONS_Interrupts(param_BasicPioDevice.BasicPioDevice):
...
class X86LocalApicParams(param_BasicPioDevice.BasicPioDeviceParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_X86LocalApic.X86LocalApicParams_create(self)
